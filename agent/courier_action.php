...
include "../admin/create_notification.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO parcels (parcel_id, sender_id, receiver_id, weight, dimensions, status, delivery_date, agent_id) VALUES (?, ?, ?, ?, ?, ?, ?,?)");
    $stmt->execute([$parcel_id, $sender_id, $receiver_id, $_POST['weight'], $_POST['dimensions'], $_POST['status'], $_POST['delivery_date'], $userId]);
