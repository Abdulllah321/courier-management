...
<body class="bg-gray-100">
    ...
    <main class="ml-64 p-6 mt-16">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6 flex justify-between" style="align-items: start;">
            <div class="mb-4 flex-grow">
                ...
                <p><strong>Status:</strong> <span
                        class="status-text"><?php echo htmlspecialchars($parcel['status']); ?></span>
                </p>
                <p><strong>Delivery Date:</strong> <span
                        class="delivery-date-text"><?php echo htmlspecialchars($parcel['delivery_date']); ?></span></p>
            </div>
            <a href="report.php?parcel_id=<?php echo $parcelId; ?>"><button class="px-4 py-2 bg-red-600 rounded-md text-white self-start">Generate Report <i
