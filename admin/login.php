            ...
            <form method="post" action="">
                <div class="mb-4">
                    ...
                    <input type="text" name="username"
                        class="w-full px-3 py-2 border border-gray-300 rounded ring-1ring-transparent transition-all duration-300 outline-none focus:outline-none focus:ring-2 focus:ring-red-600"
                        required>
                </div>
                <div class="mb-4">
